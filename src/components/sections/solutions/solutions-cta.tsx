  ...
  return (
    ...
    >
      <div className="relative group">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#3d55e2]/20 via-[#5facdb]/20 to-[#A100FF]/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-700"></div>
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-lg rounded-3xl border border-gray-700/50 group-hover:border-[#5facdb]/30 transition-all duration-500"></div>

        <div className="relative p-16 max-w-4xl mx-auto">
          {/* Decorative elements */}
          ...
          <p className="text-gray-300 text-xl mb-12 leading-relaxed font-light max-w-3xl mx-auto">
